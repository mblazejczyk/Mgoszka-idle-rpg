...
public class SettingsSystem : MonoBehaviour
{
    ...
    void Awake()
    {
        if(PlayerPrefs.GetInt("FirstResolution") == 0)
        {
        ...
        else
        {
            ...
            {
                case 0:
                    Screen.SetResolution(120, 235, false);
                    break;
                case 1:
                    Screen.SetResolution(240, 470, false);
                    break;
                case 2:
                    Screen.SetResolution(320, 480, false);
                    break;
                case 3:
                    Screen.SetResolution(480, 940, false);
                    break;
                case 4:
                    Screen.SetResolution(720, 1410, false);
                    break;
                case 5:
                    Screen.SetResolution(960, 1880, false);
                    break;
                case 6:
                    Screen.SetResolution(1440, 2820, false);
                    break;
                case 7:
                    Screen.SetResolution(1920, 3760, false);
                    break;
            }
        }
    ...
    public void ChangeResolution(Dropdown dd)
    {
        switch (dd.value)
        {
            case 0:
        ...
        PlayerPrefs.SetInt("Resolution", dd.value);
    }
    ...
    {
        Application.OpenURL("https://docs.google.com/forms/d/e/1FAIpQLSdnhKIO5vVnuF9CGRCENtuRKKoM5XnnE7RjQdnjsczZLYWYjg/viewform?usp=sf_link");
    }
    ...
    public void LoadSettings()
    {
        ...
        switch (Framerate)
        {
            ...
            case 120:
                ...
                break;
            case 240:
                framerateText.text = "Limit FPS: 240";
                break;
            case -1:
